...
# class Order:
#
#     def __init__(self, item_id: int, created_date: datetime, pages_visited: List[int], price: float):
...
class Order:
    ...
    def __init__(self, item_id: int, created_date: datetime, price: float, pages_visited=None):
